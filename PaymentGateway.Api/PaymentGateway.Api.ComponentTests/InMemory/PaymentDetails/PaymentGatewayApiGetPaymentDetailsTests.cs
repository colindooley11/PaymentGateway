namespace PaymentGateway.Api.ComponentTests.InMemory.PaymentDetails
{
    ...
    public class PaymentGatewayApiGetPaymentDetailsTests
    {
        ...
        public class Given_An_Existing_Card_Payment
        {
            ...
            private PaymentDetailsResponse _savedPaymentDetails;
            ...
            public async Task When_Retrieving_Payment_Details()
            {
                ...
                _savedPaymentDetails = new PaymentDetailsResponse()
                {
                    PaymentStatus = PaymentStatusEnum.Success,
                    CVV = 1,
                    ExpiryMonth = 12,
                    ExpiryYear = 25,
                    FirstSixLastFour = "444433******1111",
                };
            ...
            public async Task Then_The_Payload_Is_Retrieved_From_The_Database()
            {
                ...
                Assert.AreEqual(_savedPaymentDetails.PaymentStatus, paymentDetailsResponse.PaymentStatus);
                Assert.AreEqual(_savedPaymentDetails.FirstSixLastFour, paymentDetailsResponse.FirstSixLastFour);
